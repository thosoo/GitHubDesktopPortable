!macro CustomCodePostInstall
    ...
    CreateDirectory $INSTDIR\App\GithubDesktop\app-3.2.3
    CopyFiles /silent "$INSTDIR\App\setup\lib\net45\*" "$INSTDIR\App\GithubDesktop\app-3.2.3"
    ...
    FileWrite $9 "$\"%~dp0\..\app-3.2.3\resources\app\static\github.bat$\" %*$\r$\n"
