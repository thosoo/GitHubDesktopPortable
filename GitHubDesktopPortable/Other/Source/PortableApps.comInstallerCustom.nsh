!macro CustomCodePostInstall
    ...
    CreateDirectory $INSTDIR\App\GithubDesktop\app-3.2.4
    CopyFiles /silent "$INSTDIR\App\setup\lib\net45\*" "$INSTDIR\App\GithubDesktop\app-3.2.4"
    ...
    FileWrite $9 "$\"%~dp0\..\app-3.2.4\resources\app\static\github.bat$\" %*$\r$\n"
